  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-6xl relative">
        ...
        {/* grid */}
        <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center mb-20">
          {/* text */}
          ...
          <div className="space-y-6">
            ...
            <Card className="relative overflow-hidden p-6 rounded-2xl border border-slate-700 bg-card/60 backdrop-blur transition-all duration-300 hover:scale-[1.03] hover:border-sky-500 hover:shadow-[0_0_20px_rgba(56,189,248,0.6)]">
              <div className="relative flex items-start gap-4">
            ...
            <Card className="relative overflow-hidden p-6 rounded-2xl border border-slate-700 bg-card/60 backdrop-blur transition-all duration-300 hover:scale-[1.03] hover:border-fuchsia-500 hover:shadow-[0_0_20px_rgba(217,70,239,0.6)]">
              <div className="relative flex items-start gap-4">
