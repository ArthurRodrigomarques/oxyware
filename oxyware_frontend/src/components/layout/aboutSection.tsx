    ...
    >
      <div className="container mx-auto max-w-6xl relative text-white">
        <div className="pointer-events-none absolute inset-0 opacity-10">
          <div className="absolute top-20 left-10 w-32 h-32 bg-primary rounded-xl blur-3xl" />
          <div className="absolute bottom-20 right-10 w-40 h-40 bg-secondary rounded-xl blur-3xl" />
        </div>
        ...
        <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center mb-20 text-white">
          ...
          <div className="space-y-6 text-white">
            <Card className="relative overflow-hidden p-6 rounded-xl border border-slate-700 bg-card/60 backdrop-blur transition-all duration-300 hover:scale-[1.02] hover:border-purple-500">
            ...
            <Card className="relative overflow-hidden p-6 rounded-xl border text-white border-slate-700 bg-card/60 backdrop-blur transition-all duration-300 hover:scale-[1.02] hover:border-sky-500">
              <div className="relative flex items-start gap-4">
            ...
            <Card className="relative overflow-hidden p-6 rounded-xl border text-white border-slate-700 bg-card/60 backdrop-blur transition-all duration-300 hover:scale-[1.02] hover:border-fuchsia-500">
              <div className="relative flex items-start gap-4">
