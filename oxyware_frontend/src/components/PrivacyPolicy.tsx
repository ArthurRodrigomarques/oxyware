export default function PrivacyPolicy() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-zinc dark:prose-invert space-y-4 text-lg">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to oxyware, São Paulo.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Oxyware, accessible from{" "}
            <a
              href="https://www.oxyware.com.br"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.oxyware.com.br
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: oxywaretech@gmail.com</p>
        </li>
        <li>
          <p>By phone number: 13991908771</p>
        </li>
      </ul>
    </div>
  );
